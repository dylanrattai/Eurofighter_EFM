...
private:
	...
	//New test
	double m_newspawn1 = 0.0;
	double m_newspawn2 = 0.0;
...
{
	double RPM_Normal2 = 0.0;


	if ((m_hasFuel == true) && (m_ignitors2 == true) && (m_rpmPrevious2 < 0.685))
	{
		RPM_Normal2 = updateSpoolCold2();
		m_rpmNormal2 = RPM_Normal2;
		//m_rpmPrevious = m_rpmNormal;
	}
	...
	else if ((m_hasFuel == true) && (m_ignitors2 == true)) // && (m_rpmPrevious >= 0.70))
	{
		...
		if (updateSpool2() >= 0.01)
		{
			RPM_Normal2 = 0.70 + (updateSpool2() * 0.40);
		}
